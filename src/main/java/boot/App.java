...
public class App {
    ...
    aetherShim() throws Exception {
        if (aethershim == null) {
            ...
            aethershim = newShim("aether", null, new File[] { }); }
    System.out.println("DUDE! aether!!!!!!!!!!!!!!!");
        return aethershim; }
    ...
    runBoot(Future<ClojureRuntimeShim> core,
        ...
        try {
            ...
            for (int i=0; i < ee.length; ++i) {
              System.out.println("element === " + ee[i].toString());
            }
            System.out.println("$$$$$$$$$$$$$$$$$$");
            t.printStackTrace();
            return -2; }
    ...
    updateBoot(File bootprops, String version, String chan) throws Exception {
        ...
        private static void xxx(String pfx, File[] ff) throws Exception {
            System.out.println("XXXXXXXXXXXXX = " + pfx);
            for (File f : ff) {
...
System.out.println("boot-dir ===== " + bootdir());
        ...
        //xxx("podjars", podjars);
        //xxx("corejars", corejars);
        //xxx("workerjars", workerjars);
