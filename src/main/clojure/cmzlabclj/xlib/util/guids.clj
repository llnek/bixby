...
(ns ^{:doc "Ways to generate an unique id."
  ...
  (:use [cmzlabclj.xlib.util.core :only [NowMillis TryC NewRandom]]
        [cmzlabclj.xlib.util.str :only [nsb Left Right]]
        [cmzlabclj.xlib.util.bytes :only [ReadInt ReadLong]]
        [cmzlabclj.xlib.util.seqnum :only [NextInt]])
