...
(ns ^{ :doc ""
  ...
  cmzlabsclj.dbio.connect

  (:require [clojure.tools.logging :as log :only [info warn error debug] ])
  (:require [cmzlabsclj.dbio.core :as dbcore :only [MakeDbPool] ])
  (:require [clojure.string :as cstr])
  (:use [cmzlabsclj.util.core :only [Try!] ])
  (:use [cmzlabsclj.util.str :only [nsb] ])
  (:use [cmzlabsclj.dbio.composite])
  (:use [cmzlabsclj.dbio.simple])
  (:use [cmzlabsclj.dbio.sqlserver])
  (:use [cmzlabsclj.dbio.postgresql])
  (:use [cmzlabsclj.dbio.mysql])
  (:use [cmzlabsclj.dbio.oracle])
