...
(defn EveUnbind ""
  ...
  [^cmzlabsclj.util.core.MubleAPI ev]
...
(defn EveBind ""
  ...
  [^cmzlabsclj.util.core.MubleAPI ev obj]
...
(defmethod EveSetSession :czc.tardis.io/EmEvent
  ...
  [^cmzlabsclj.util.core.MubleAPI obj ss]
...
(defmethod EveDestroy :czc.tardis.io/EmEvent
  ...
  [^cmzlabsclj.util.core.MubleAPI obj]
...
(defmethod EveSetResult :czc.tardis.io/EmEvent
  ...
  (let [ ^cmzlabsclj.tardis.io.core.WaitEventHolder
         weh (.getf ^cmzlabsclj.util.core.MubleAPI obj :waitEventHolder)
         ss (.getSession obj)
         src (.emitter obj) ]
    (when-not (nil? ss) (.handleResult ss obj res))
    (.setf! ^cmzlabsclj.util.core.MubleAPI obj :result res)
    (when-not (nil? weh)
      (try
        (.resumeOnResult weh res)
        (finally
          (.setf! ^cmzlabsclj.util.core.MubleAPI obj :waitEventHolder nil)
          (.release ^cmzlabsclj.tardis.io.core.EmitterAPI src weh))))
  ))
