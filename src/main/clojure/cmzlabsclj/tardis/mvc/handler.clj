...
(ns ^{ :doc ""
  ...
  (:use [cmzlabsclj.nucleus.util.core
        ...
        [cmzlabsclj.tardis.io.http :only [HttpBasicConfig] ]
        [cmzlabsclj.tardis.io.netty]
        [cmzlabsclj.tardis.io.core]
        [cmzlabsclj.tardis.core.sys]
        [cmzlabsclj.tardis.core.constants]
        [cmzlabsclj.tardis.mvc.templates
         :only [SetCacheAssetsFlag GetLocalFile ReplyFileAsset] ]
        [cmzlabsclj.tardis.mvc.comms]
        [cmzlabsclj.nucleus.util.str :only [hgl? nsb strim] ]
        [cmzlabsclj.nucleus.util.meta :only [MakeObj] ]
        [cmzlabsclj.nucleus.net.routes])
...
(defn- mvcInitor ""
  ...
  [^cmzlabsclj.tardis.core.sys.Element co options1]
