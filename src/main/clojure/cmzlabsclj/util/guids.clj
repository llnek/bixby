...
(ns ^{ :doc "Ways to generate an unique id."
  ...
  cmzlabsclj.util.guids

  (:require [clojure.tools.logging :as log :only [info warn error debug] ])
  (:require [cmzlabsclj.util.str :as zstr :only [Left Right] ])
  (:require [clojure.string :as cstr])
  (:use [cmzlabsclj.util.core :only [NowMillis TryC NewRandom] ])
  (:use [cmzlabsclj.util.bytes :only [ReadInt ReadLong] ])
