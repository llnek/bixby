...
(ns ^{ :doc ""
  ...
  (:require [clojure.tools.logging :as log :only [info warn error debug] ]
            ...
            [cmzlabsclj.nucleus.dbio.core :as dbcore :only [ese] ]
            [cmzlabsclj.nucleus.dbio.sql :as dbsql ])
  (:use [cmzlabsclj.nucleus.util.core :only [test-nonil notnil? Try!] ]
        [cmzlabsclj.nucleus.util.str :only [hgl?] ])
  (:import  [com.zotohlab.frwk.dbio Transactable SQLr MetaCache DBAP]
            [java.sql Connection]))
