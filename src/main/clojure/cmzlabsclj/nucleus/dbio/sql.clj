...
(ns ^{ :doc ""
  ...
  cmzlabsclj.nucleus.dbio.sql

  (:require [clojure.tools.logging :as log :only [info warn error debug] ])
  (:require [clojure.string :as cstr])
  (:use [cmzlabsclj.nucleus.util.core :only [FlattenNil notnil? NowJTstamp nnz] ])
  (:use [cmzlabsclj.nucleus.util.meta :only [BytesClass CharsClass] ])
  (:use [cmzlabsclj.nucleus.util.str :only [AddDelim! nsb strim] ])
  (:use [cmzlabsclj.nucleus.util.io :only [ReadChars ReadBytes ] ])
  (:use [cmzlabsclj.nucleus.util.dates :only [GmtCal] ])
...
(defn- make-sql ""
  ...
  ^cmzlabsclj.nucleus.dbio.sql.SQueryAPI
...
(defn MakeProc ""
  ...
  ^cmzlabsclj.nucleus.dbio.sql.SQLProcAPI
