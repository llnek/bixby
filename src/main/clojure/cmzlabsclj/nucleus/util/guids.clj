...
(ns ^{ :doc "Ways to generate an unique id."
  ...
  cmzlabsclj.nucleus.util.guids

  (:require [clojure.tools.logging :as log :only [info warn error debug] ])
  (:require [cmzlabsclj.nucleus.util.str :as zstr :only [Left Right] ])
  (:require [clojure.string :as cstr])
  (:use [cmzlabsclj.nucleus.util.core :only [NowMillis TryC NewRandom] ])
  (:use [cmzlabsclj.nucleus.util.bytes :only [ReadInt ReadLong] ])
