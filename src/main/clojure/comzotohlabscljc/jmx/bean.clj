...
(use '[comzotohlabscljc.util.core :only [make-mmap notnil? TryC] ])
(use '[comzotohlabscljc.util.str :only [has-any?] ])
(use '[comzotohlabscljc.util.meta :only [is-boolean? is-void? is-object?
