...
//  val CLASSES="classes"
  ...
  val PF_SKARO_APPDOMAIN="skaro.app.domain"
  val PF_SKARO_APPID="skaro.appid"
  val PF_SKARO_APPTASK="skaro.app.task"

  val PF_JMXMGM="jmx-management"
  val PF_HOMEDIR="skaro.home"
  val PF_PROPS="skaro.conf"
